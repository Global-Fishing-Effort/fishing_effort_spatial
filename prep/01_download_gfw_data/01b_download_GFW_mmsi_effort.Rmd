...
To download the China data, we need to split into more than 3 data pulls. Let's try with 5 different time periods so we can alleviate pressure on the API
...
test_mmsi_v2 <- read.csv(file.path(rdsi_raw_dir, "global_fishing_watch/apparent_fishing_hours_mmsi/v2/CAN_8493_2015_annual_effort_grid_highres.csv"))
...
sum(test_mmsi_v2$apparent_fishing_hours) # 256931

sum(test_mmsi_v3$apparent_fishing_hours) # 219563.2

## they are pretty close, v3 is off by ~40k hours for some reason... maybe re-pull for this region and double check? 
...
test_mmsi_v2 <- read.csv(file.path(rdsi_raw_dir, "global_fishing_watch/apparent_fishing_hours_mmsi/v2/BGR_5672_2015_annual_effort_grid_highres.csv"))
...
sum(test_mmsi_v2$apparent_fishing_hours) # 17871.92
...
test_mmsi_v2 <- read.csv(file.path(rdsi_raw_dir, "global_fishing_watch/apparent_fishing_hours_mmsi/v2/IDN_8492_2015_annual_effort_grid_highres.csv"))
...
sum(test_mmsi_v2$apparent_fishing_hours) # 2389.98

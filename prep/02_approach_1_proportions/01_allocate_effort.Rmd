...
We take GFW data and calculate for each gear type, vessel length, flag countryf, and EEZ, the proportion of catch occurring in that cell out of the total for those categories. 
...
ggsave(plot = p, here("prep/02_allocation_proportions/figs/prorate_by_sector.png"), height = 12, width = 12, dpi = 300, bg = "white")
...
plot(log(test_gfw_2+1)) ## ok, so plotting the 0.01 resolution looks so much different. I think I will just go with the 0.1 degree resolution, because it will be SO MUCH easier computationally. It will take higher start up to get all of the variables we need, for every year. 

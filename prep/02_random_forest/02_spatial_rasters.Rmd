...
fwrite(eez_raster_df, here("int/eez_raster_df.csv"), row.names = FALSE) ## cool, this is the df that we need to join with gfw csvs to identify the eez area where the fishing is happening, irrespective of flag country
...
writeRaster(eez_raster, here("int/land_raster.tif"), overwrite = TRUE)

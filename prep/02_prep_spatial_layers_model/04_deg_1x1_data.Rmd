...
all_sst <- lapply(files, read.csv) %>%
  bind_rows() %>%
  filter(year != 2014) # we only run models for 2015-2024
...
Prep 2014-2024 Wind data and save
...
eez_region_features <- eez_lookup_ids %>%
  ...
  mutate(eez_region_world_bank_7 = ifelse(eez_sovereign == "ESH", "Middle East & North Africa", eez_region_world_bank_7))

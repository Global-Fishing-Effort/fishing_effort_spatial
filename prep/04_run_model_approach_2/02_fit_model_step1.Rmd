...
#  row = 1 
 ...
 # yr = 2017
  ...
  if(file.exists(glue(file.path(rdsi_dir, "data_storage/prep/logistic_regression_outputs/fitted_model_{flag}_{gear_type}_{length}_{yr}.rds")))){
    cat("exists... next")
    next()
  }
...
# Save model
saveRDS(model, glue(file.path(rdsi_dir, "data_storage/prep/logistic_regression_models/fitted_model_{flag}_{gear_type}_{length}_{yr}.rds")))

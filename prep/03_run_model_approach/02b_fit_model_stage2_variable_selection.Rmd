...
if(!file.exists(glue(file.path(rdsi_dir, "prep/random_forest/stage_2_models/pruning/stage_2_rf_train_{flag}_27.qs")))){
tic()
  model <- ranger(
  formula = full_model_formula,
  data = train,
...
toc() # half a second for NZL; 45 secs for CHN
  ...
  model <- qs::qread(glue(file.path(rdsi_dir, "prep/random_forest/stage_2_models/pruning/stage_2_rf_train_{flag}_27.qs")))

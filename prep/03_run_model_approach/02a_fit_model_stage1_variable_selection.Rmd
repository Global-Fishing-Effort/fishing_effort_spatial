...
foreach(flag = flags, .packages = c("dplyr", "tidyr", "randomForest", "qs", "glue", "tictoc", "ranger", "PRROC")) %dopar% {
  ...
  if(!file.exists((glue(file.path(rdsi_dir, "prep/random_forest/stage_1_models/pruning/stage_1_rf_train_{flag}_27.qs"))))){
...
# stage_1_flags <- unique(c("CHN", stage_1_flags)) # move CHN and USA to the front of the list since they take the longest to run...

...
doParallel::registerDoParallel(cl)
 ...
 foreach(flag = flags_missing, .packages = c("dplyr", "tidyverse", "randomForest", "qs", "glue", "ranger")) %dopar% {
    #  flag = "STP"
...
if (length(matching_files) > 0) {
  ...
  stage2_model <- qs::qread(file.path(rdsi_dir, "prep/random_forest/stage_2_models/", "stage_2_rf_model_full_data_PRT_26.qs"))
 } else if (flag %in% c("MYT")) {
      stage2_model <- qs::qread(file.path(rdsi_dir, "prep/random_forest/stage_2_models/", "stage_2_rf_model_full_data_FRA_26.qs"))
...
if (length(matching_files) > 0) {
  ...
  stage1_model <- qs::qread(file.path(rdsi_dir, "prep/random_forest/stage_1_models/", "stage_1_rf_model_full_data_PRT_26.qs"))
 } else if (flag %in% c("MYT")) {
      stage1_model <- qs::qread(file.path(rdsi_dir, "prep/random_forest/stage_1_models/", "stage_1_rf_model_full_data_FRA_26.qs"))
...
test <- qread(file.path(rdsi_dir, "prep/random_forest/predictions_regional/model_preds_1950_2017_BEN.qs"))

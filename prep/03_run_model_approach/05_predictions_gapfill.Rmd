...
```{r}
 ...
 modelled_flags_original <- str_before_first(str_after_last(list.files(file.path(rdsi_dir, "prep/random_forest/predictions_industrial_flag_revised/"), pattern = ".qs", full.names = TRUE), "_"), "\\.qs")

  all_files_flag <- list.files(file.path(rdsi_dir, "prep/random_forest/predictions_industrial_flag_revised/"), full.names = TRUE)

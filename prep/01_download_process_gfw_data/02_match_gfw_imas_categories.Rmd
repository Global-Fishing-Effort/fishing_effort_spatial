...
In this script we match gear types (aside from trawling gears, which we do in 02 script) in the global fishing watch data and the Rousseau et al., 2024 data. 
...
**Native resolution**: 0.05 degrees, country level 

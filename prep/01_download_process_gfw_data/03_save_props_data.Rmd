...
qs::qsave(gfw_fix_props, file.path(rdsi_dir, glue("prep/prorate_allocation/{res}/gfw_effort/all_effort_gear_length_props_{y}.qs")))
...
test <- qs::qread(file.path(rdsi_dir, "prep/prorate_allocation/lowres/gfw_effort/all_effort_gear_length_props_2012.qs"))

...
## took ~4 mins for flag country Australia using 20 cores (i think using that many cores...?). 
...
# randomForest() # random forest instead of logistic regression???? Or maybe try a regular logistic regression using stats::glm without smoothing parameters. maybe those would be faster?

...
# problems with categorical predictors: rf does not like them in model formula as done for glm; also Error in randomForest.default(m, y, ...) : 
  # Can not handle categorical predictors with more than 53 categories.
# should we not convert?? some transformation neede https://www.geeksforgeeks.org/how-to-fit-categorical-data-types-for-random-forest-classification/
...
# 
# filter(data_random_forest, is.na(presence))
# filter(data_random_forest, is.na(sst_c_mean))

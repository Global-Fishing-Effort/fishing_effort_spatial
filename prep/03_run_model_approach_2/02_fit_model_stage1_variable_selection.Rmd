...
stage_1_flags <- setdiff(stage_1_flags, c("ZAF", "TON", "AGO", "ALB", "ARG", "AUS", "BEL", "BGR", "BRA", "CAN"))
...
#  flag = "AGO"
  ...
  tic()
  model <- randomForest(rf_formula, data = data_random_forest, type = "classification", proximity = FALSE, ntree = 100, importance = TRUE)
  toc()
...
# stopCluster(cl)
# test <- qs::qread("/home/ubuntu/data_storage/prep/random_forest/stage_1_models/stage_1_rf_model_full_data_AGO_19.qs")
